            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">{t('about.features.dataDriven.title')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('about.features.dataDriven.description')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">{t('about.features.transparent.title')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('about.features.transparent.description')}</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-gray-900 dark:text-white">{t('about.features.customized.title')}</h3>
                    <p className="text-gray-600 dark:text-gray-300">{t('about.features.customized.description')}</p>
                  </div>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-700 p-8 rounded-lg shadow-lg">
              <div className="grid grid-cols-2 gap-8 text-center">
                ...
                <div>
                  ...
                  <div className="text-gray-600 dark:text-gray-300">{t('about.stats.team')}</div>
                </div>
                <div>
                ...
                <div>
                  ...
                  <div className="text-gray-600 dark:text-gray-300">{t('about.stats.clients')}</div>
                </div>
              </div>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="font-semibold text-gray-900 dark:text-white">{t('contact.info.address')}</div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#services" className="hover:text-white transition-colors">{t('footer.services.seo')}</a></li>
                <li><a href="#services" className="hover:text-white transition-colors">{t('footer.services.ppc')}</a></li>
                <li><a href="#services" className="hover:text-white transition-colors">{t('footer.services.social')}</a></li>
                <li><a href="#services" className="hover:text-white transition-colors">{t('footer.services.content')}</a></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><a href="#about" className="hover:text-white transition-colors">{t('footer.company.about')}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t('footer.company.team')}</a></li>
                <li><a href="#portfolio" className="hover:text-white transition-colors">{t('footer.company.cases')}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t('footer.company.careers')}</a></li>
              </ul>
            </div>
            
            <div>
              <h4 className="text-lg font-semibold mb-4">{t('footer.connect.title')}</h4>
              <ul className="space-y-2 text-gray-400">
                <li><a href="#" className="hover:text-white transition-colors">{t('footer.connect.facebook')}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t('footer.connect.linkedin')}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t('footer.connect.twitter')}</a></li>
                <li><a href="#" className="hover:text-white transition-colors">{t('footer.connect.instagram')}</a></li>
              </ul>
            </div>
          </div>
